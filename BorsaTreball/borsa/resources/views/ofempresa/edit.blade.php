                                    ...
                                    <form method="POST" action="{{ route('ofempresa.update', $oferta) }}" enctype="multipart/form-data">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div>
                                                ...
                                                <input type="text" id="name" name="name" value="{{ $oferta -> name }}">
                                                <br><br>
                                                <label  for="sala" class="col-10">Salari: </label>
                                                <input type="num" id="sala" name="sala" value="{{ $oferta -> sala }}">
                                                <br><br>
                                                <label for="h"  class="col-10">Horari:</label>
                                                <input type="text" id="h" name="h"value="{{ $oferta -> h }}">
                                                <br><br>
                                                <div class="contenedor-input">
                                                    <label for="desc" class="col-10">Descripció:</label>

                                                    <textarea name="desc" rows="10" cols="50" value="{{ $oferta -> desc }}">{{ $oferta -> desc }}</textarea><br><br>
                                                </div>
