            ...
            @foreach ($pre as $key => $item)
                <tr>
                    ...
                    <td width="25%">
                        ...
                        <button type="button" class="btn btn-success" onclick="modalEdit('{{ $item->id }}','{{ $item->title }}','{{ $item->state }}','{{ $item->pre_code }}')" data-toggle="modal" data-target="#exampleModalEdit">Editar</button>
                        <button type="button" class="btn btn-danger" onclick="deletepre('{{ $item->id }}')">Eliminar</button>
                    </td>
                    <td>{{ $item->title }}</td>
                    <td>{{ $item->state }}</td>
                </tr>
