                                    ...
                                    <form action="{{route('perfilAlum.update')}}" method="PATCH">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="from-group form-row ">
                                                ...
                                                <p><b><label>{{__('Has fet practiques abans ?')}}</label></b><p>
                                                <br><br>
                                            ...
                                            <br><br>
                                            <center>
                                                <button type="submit" class="btn btn-primary">Actualització</button>
                                                <button type="reset" class="btn btn-secondary">Restableix</button>
                                            </center>
                                        </div>
                                    </form>
