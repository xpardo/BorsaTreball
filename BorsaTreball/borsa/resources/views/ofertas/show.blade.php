                                    ...
                                    <div class="contenedor ">
                                        ...
                                        <center>
                                            ...
                                            <form id="form" method="POST" action="{{ route('candi.store') }}">
                                                @csrf
                                                <!--agafar la id, nom i empre de la taula--->
                                                ...
                                                <input type="hidden" name="desc" value="{{$oferta->desc}}" />
                                                <input type="hidden" name="cicle" value="{{$oferta->cicle}}" />
                                                <input type="hidden" name="tipus" value="{{$oferta->tipus}}" />
